...
public partial class GameContext {
    ...
    public GameEntity SetUIRoot(UnityEngine.Canvas newValue) {
        if (hasUIRoot) {
    ...
    public void ReplaceUIRoot(UnityEngine.Canvas newValue) {
...
public partial class GameEntity {
    ...
    public void AddUIRoot(UnityEngine.Canvas newValue) {
