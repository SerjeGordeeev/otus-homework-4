...
public partial class GameEntity {
    ...
    public void AddPrefab(UnityEngine.GameObject newValue, UnityEngine.Transform newParentTransform) {
        var index = GameComponentsLookup.Prefab;
        var component = (PrefabComponent)CreateComponent(index, typeof(PrefabComponent));
        component.value = newValue;
        component.parentTransform = newParentTransform;
        AddComponent(index, component);
    }

    public void ReplacePrefab(UnityEngine.GameObject newValue, UnityEngine.Transform newParentTransform) {
        var index = GameComponentsLookup.Prefab;
        var component = (PrefabComponent)CreateComponent(index, typeof(PrefabComponent));
        component.value = newValue;
        component.parentTransform = newParentTransform;
